...
draw (graph(xi,0.,360.,5000),s);
draw (graph(xi1,0.,360.,5000),s);
pen s = solid + red + 1.;
draw (graph(xicos,0.,360.,5000),s);
s = solid + blue + 1.;
draw (graph(xisin,0.,360.,5000),s);
...
yaxis("$\xi^e$",LeftRight,RightTicks);
