...
!!$         PARAMETER (NPGMAP=NPMGS*NTP1)
  ...
  REAL(RKIND)      ::     ZAHPR1, ZAHPR2, ZTHSHA, ZSHA, ZFM1, ZFM2, ZFM3, ZFM4
  REAL(RKIND)      ::     ZD2BCN, TMP1, TMP2, TMP3
  REAL(RKIND)      ::     ZBETCHI, ZTET
  ...
  DIMENSION &
       ...
       &   ZAHPR1(ntp2),          ZAHPR2(ntp2),          ZTHSHA(ntp2), &
       &   tmp1(NTP2),            tmp2(npmgs*ntp1),      tmp3(npmgs*ntp1),  &
       &   ZD2BCN(NTP2),          ZBETCHI(npmgs*ntp1),   ZTET(NTP2)
  ...
  DO J1=2,NT2
     ...
     ENDIF
  ENDDO
  ! to replace by interpos periodic later (OS):
  CALL SPLINE(NT2,ZTET,BCHIN(1,K),ZD2BCN,tmp1)
  CALL PPSPLN2(IGMAX,PTETA,NT2-1,ZTET, &
       &          BCHIN(1,K),ZD2BCN,ZBETCHI,tmp2,tmp3)
  CALL SPLINE(NT2,ZTET,ZTHSHA(1),ZD2BCN,tmp1)
  CALL PPSPLN2(IGMAX,PTETA,NT2-1,ZTET, &
       &          ZTHSHA(1),ZD2BCN,ZSHA,tmp2,tmp3)
  ! 2) calculate AHPR 
...
!
  ...
  DO JFM=1,6
    ...
    ZFM4=0._RKIND
    DO J6=1,IGMAX
      ZFM1 = ZFM1 + JFM*cos(JFM*ZSHA(J6))*sqrt(ZB2(J6))*log(sqrt(ZB2(J6)))*ZDFM(J6)
      ZFM2 = ZFM2 + JFM*cos(JFM*ZSHA(J6))*ZB2(J6)*ZDFM(J6)
      ZFM3 = ZFM3 + JFM*sin(JFM*ZSHA(J6))*sqrt(ZB2(J6))*log(sqrt(ZB2(J6)))*ZDFM(J6)
      ZFM4 = ZFM4 + JFM*sin(JFM*ZSHA(J6))*ZB2(J6)*ZDFM(J6)
