...
!
  INTERFACE putarr
     MODULE PROCEDURE putarr1, putarr2, putarr3, putarr4
     MODULE PROCEDURE sputarr1, sputarr2, sputarr3, sputarr4
     MODULE PROCEDURE iputarr1, iputarr2, iputarr3, iputarr4
     MODULE PROCEDURE cputarr1, cputarr2, cputarr3, cputarr4
     MODULE PROCEDURE zputarr1, zputarr2, zputarr3, zputarr4
  END INTERFACE
  INTERFACE putarrnd
     MODULE PROCEDURE putarrnd2, putarrnd3, putarrnd4
     MODULE PROCEDURE sputarrnd2, sputarrnd3, sputarrnd4
     MODULE PROCEDURE iputarrnd2, iputarrnd3, iputarrnd4
     MODULE PROCEDURE cputarrnd2, cputarrnd3, cputarrnd4
     MODULE PROCEDURE zputarrnd2, zputarrnd3, zputarrnd4
  END INTERFACE
  INTERFACE getarr
     MODULE PROCEDURE getarr1, getarr2, getarr3, getarr4
     MODULE PROCEDURE sgetarr1, sgetarr2, sgetarr3, sgetarr4
     MODULE PROCEDURE igetarr1, igetarr2, igetarr3, igetarr4
     MODULE PROCEDURE cgetarr1, cgetarr2, cgetarr3, cgetarr4
     MODULE PROCEDURE zgetarr1, zgetarr2, zgetarr3, zgetarr4
  END INTERFACE
  INTERFACE getarrnd
     MODULE PROCEDURE getarrnd2, getarrnd3, getarrnd4
     MODULE PROCEDURE sgetarrnd2, sgetarrnd3, sgetarrnd4
     MODULE PROCEDURE igetarrnd2, igetarrnd3, igetarrnd4
     MODULE PROCEDURE cgetarrnd2, cgetarrnd3, cgetarrnd4
     MODULE PROCEDURE zgetarrnd2, zgetarrnd3, zgetarrnd4
  END INTERFACE
  INTERFACE append
  ...
  END INTERFACE
  INTERFACE attach
     MODULE PROCEDURE attach_i, attach_r, attach_f, attach_l, attach_s
  END INTERFACE
  INTERFACE getatt
...
!
    prec(fid) = H5T_IEEE_F32LE       ! Use 32 bit real by default
    IF( PRESENT(real_prec) ) THEN
       IF( real_prec .EQ. 'd' .OR. real_prec .EQ. 'D') THEN
          prec(fid) = H5T_IEEE_F64LE
       END IF
    END IF
!
    CALL attach(fid, '/', 'prec', prec(fid))
!
...
!
    ...
    IF( ierr .EQ. -1 ) THEN
       ...
       CALL h5acreate_f(oid, attr, prec(fid), attr_space, attr_id, ierr)
...
!===========================================================================
  SUBROUTINE getatt_i(fid, name, attr, ival)
!
...
!===========================================================================
  SUBROUTINE getatt_s(fid, name, attr, sval)
!
...
!===========================================================================
  SUBROUTINE getatt_r(fid, name, attr, val)
!
...
!===========================================================================
  SUBROUTINE getatt_f(fid, name, attr, val)
!
...
!===========================================================================
  SUBROUTINE getatt_l(fid, name, attr, lval)
!
!  Get a real attribute from group/dataset
!
    IMPLICIT NONE
