subroutine assign_code_parameters(codeparameters, return_status)
  ...
  outer: do
     ...
     case ("dlambda")
        ! array
        if (allocated(temp_pointer%cvalue)) &
             call scan_str2num(char2str(temp_pointer%cvalue), dlambda, n_values)
        ! IF (NVERBOSE .GE. 2) print *,' dlambda= ',dlambda
        ! IF (NVERBOSE .GE. 2) print *,' n_values= ',n_values
     case ("dplace")
        ! array
        if (allocated(temp_pointer%cvalue)) &
     ...
     case ("dpsi_ni")
        ! array
        if (allocated(temp_pointer%cvalue)) &
             call scan_str2num(char2str(temp_pointer%cvalue), dpsi_ni, n_values)
        ! IF (NVERBOSE .GE. 2) print *,' dpsi_ni= ',dpsi_ni
        ! IF (NVERBOSE .GE. 2) print *,' n_values= ',n_values
     case ("dpsi_ti")
        ! array
        if (allocated(temp_pointer%cvalue)) &
             call scan_str2num(char2str(temp_pointer%cvalue), dpsi_ti, n_values)
        ! IF (NVERBOSE .GE. 2) print *,' dpsi_ni= ',dpsi_ti
        ! IF (NVERBOSE .GE. 2) print *,' n_values= ',n_values
     case ("dwidth")
        ! array
        if (allocated(temp_pointer%cvalue)) &
     ...
     case ("lambda0")
        ! array
        if (allocated(temp_pointer%cvalue)) &
             call scan_str2num(char2str(temp_pointer%cvalue), lambda0, n_values)
        ! IF (NVERBOSE .GE. 2) print *,' lambda0= ',lambda0sig
        ! IF (NVERBOSE .GE. 2) print *,' n_values= ',n_values
     case ("qplace")
        ! array
        if (allocated(temp_pointer%cvalue)) &
     ...
     case ("sd_vmin")
        ! array
        if (allocated(temp_pointer%cvalue)) &
             call scan_str2num(char2str(temp_pointer%cvalue), sd_vmin, n_values)
        ! IF (NVERBOSE .GE. 2) print *,' sd_vmin= ',sd_vmin
     case ("sd_vmax")
        ! array
        if (allocated(temp_pointer%cvalue)) &
             call scan_str2num(char2str(temp_pointer%cvalue), sd_vmax, n_values)
        ! IF (NVERBOSE .GE. 2) print *,' sd_vmax= ',sd_vmax
     ...
     case ("spitzer")
        ...
        ! IF (NVERBOSE .GE. 2) print *,' spitzer= ',spitzer
