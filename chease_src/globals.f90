...
!!! Static vars and arrays
  ...
  REAL(RKIND), DIMENSION(10), SAVE ::                         dlambda     = 101._rkind    ! HL for XTOR
  ...
  REAL(RKIND), DIMENSION(10), SAVE ::                         dpsi_ni     = 0._RKIND      ! HL for XTOR 
  REAL(RKIND), DIMENSION(10), SAVE ::                         dpsi_ti     = 0._RKIND      ! HL for XTOR 
  ...
  REAL(RKIND), DIMENSION(10), SAVE ::                         lambda0     = 0._RKIND     ! HL for XTOR 
  ...
  REAL(RKIND), DIMENSION(10), SAVE ::                         sd_vmin     = 0._RKIND     ! HL for XTOR 
  REAL(RKIND), DIMENSION(10), SAVE ::                         sd_vmax     = 0._RKIND     ! HL for XTOR 
  ...
  REAL(RKIND), SAVE ::                                        spitzer     = 0._RKIND    !HL for xtor
  ...
  REAL(RKIND), DIMENSION( :,:), ALLOCATABLE, SAVE ::          tetchi
